	...
	if (h_skew == SDC_ADFR) {
		if (oplus_adfr_auto_mode == OPLUS_ADFR_AUTO_OFF) {
			if (refresh_rate == 120) {
				...
				/* locked in 90hz */
				if ((strcmp(oplus_display_get_panel_name(crtc), "oplus21135_tm_nt37705_fhd_dsi_cmd"))
					&& (strcmp(oplus_display_get_panel_name(crtc), "AC068_P_3_A0001_fhd_cmd"))
					&& (strcmp(oplus_display_get_panel_name(crtc), "oplus22023_samsung_amf680cm01_fhd_dsi_cmd")))
