...
int oplus_display_backlight_property_update(struct drm_crtc *crtc, int prop_id, unsigned int prop_val)
{
	...
	oplus_disp_trace_begin("oplus_display_backlight_property_update");
	switch (prop_id) {
	...
	oplus_disp_trace_end("oplus_display_backlight_property_update");
...
void oplus_sync_panel_brightness(struct drm_crtc *crtc)
{
	...
	oplus_disp_trace_begin("sync_panel_brightness level(%d)", mtk_crtc->oplus_pending_backlight);
	mtk_drm_setbacklight_without_lock(crtc, mtk_crtc->oplus_pending_backlight, 0, 0x1 << SET_BACKLIGHT_LEVEL);
	oplus_disp_trace_end("sync_panel_brightness level(%d)", mtk_crtc->oplus_pending_backlight);
}
