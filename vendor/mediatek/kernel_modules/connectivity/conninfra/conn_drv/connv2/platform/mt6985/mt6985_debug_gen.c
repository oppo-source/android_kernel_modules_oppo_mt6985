 ...
 *
 * This file, mt6985_debug_gen.c was automatically generated
 * by the tool from the DEBUG data DE provided.
 * It should not be modified by hand.
 *
 * Reference debug file,
 * - [Dxxxc]connsys_power_debug.xlsx (Modified date: 2022-04-08)
 * - [Dxxxc]conn_infra_bus_debug_ctrl.xlsx (Modified date: 2022-03-29)
 */
...
#include "mt6985_debug_gen.h"
#include "conninfra.h"


mapped_addr vir_addr_consys_dbg_gen_srclkenrc_base_mt6985;
mapped_addr vir_addr_consys_dbg_gen_topckgen_base_mt6985;
mapped_addr vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6985;
...
{
	vir_addr_consys_dbg_gen_srclkenrc_base_mt6985
		= ioremap(CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR, 0x780);
	vir_addr_consys_dbg_gen_topckgen_base_mt6985
		= ioremap(CONSYS_DBG_GEN_TOPCKGEN_BASE_ADDR, 0xD4);
	vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6985
		= ioremap(CONSYS_DBG_GEN_CONN_DBG_CTL_BASE_ADDR, 0x420);
	vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6985
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_OFFSET_ADDR, 0xAD0);
	vir_addr_0x1804c000_mt6985
...
{
	if (vir_addr_consys_dbg_gen_srclkenrc_base_mt6985)
		iounmap(vir_addr_consys_dbg_gen_srclkenrc_base_mt6985);

	if (vir_addr_consys_dbg_gen_topckgen_base_mt6985)
		iounmap(vir_addr_consys_dbg_gen_topckgen_base_mt6985);

	if (vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6985)
		iounmap(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6985);

	if (vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6985)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6985);

	if (vir_addr_0x1804c000_mt6985)
		iounmap(vir_addr_0x1804c000_mt6985);

	if (vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6985)
		iounmap(vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6985);
}

void update_debug_read_info_mt6985_debug_gen(
		struct conn_debug_info_mt6985 *info,
		char *tag,
...
void update_debug_write_info_mt6985_debug_gen(
		struct conn_debug_info_mt6985 *info,
		char *tag,
...
void consys_print_power_debug_dbg_level_0_mt6985_debug_gen(
		int level,
		struct conn_debug_info_mt6985 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
		return;

	memset(pdbg_level_0_info, 0, sizeof(struct conn_debug_info_mt6985));

	if (level < 0)
		return;

	if (!vir_addr_consys_dbg_gen_srclkenrc_base_mt6985) {
		pr_notice("vir_addr_consys_dbg_gen_srclkenrc_base_mt6985(%x) ioremap fail\n",
				CONSYS_DBG_GEN_SRCLKENRC_BASE_ADDR);
		return;
	}

	if (!vir_addr_consys_dbg_gen_topckgen_base_mt6985) {
		pr_notice("vir_addr_consys_dbg_gen_topckgen_base_mt6985(%x) ioremap fail\n",
	...
	/* A0: 0x1c00_1854 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_0_info,
	...
	/* A1 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_0_info,
		"A1", 0x1C00D000 + CONSYS_DBG_GEN_M06_REQ_STA_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6985 +
			CONSYS_DBG_GEN_M06_REQ_STA_0_OFFSET_ADDR));

	/* A1 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_0_info,
		"A1", 0x1C00D000 + CONSYS_DBG_GEN_M09_REQ_STA_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_srclkenrc_base_mt6985 +
	...
	/* A23: 0x1c00_1e04 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_0_info,
		"A23", 0x1c001000 + CONSYS_DBG_GEN_SPM_CONN_PWR_CON_OFFSET_ADDR,
		CONSYS_REG_READ(SPM_BASE_ADDR + CONSYS_DBG_GEN_SPM_CONN_PWR_CON_OFFSET_ADDR));

	/* A24 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_0_info,
		"A24", 0x10000000 + CONSYS_DBG_GEN_CLK_CFG_12_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_topckgen_base_mt6985 +
...
void consys_print_power_debug_dbg_level_1_mt6985_debug_gen(
		int level,
		struct conn_debug_info_mt6985 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
		return;

	memset(pdbg_level_1_info, 0, sizeof(struct conn_debug_info_mt6985));

	if (level < 1)
		return;

	if (!vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6985) {
		pr_notice("vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6985(%x) ioremap fail\n",
	...
	update_debug_write_info_mt6985_debug_gen(pdbg_level_1_info,
...
void consys_print_power_debug_dbg_level_2_mt6985_debug_gen(
		int level,
		struct conn_debug_info_mt6985 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
		return;

	memset(pdbg_level_2_info, 0, sizeof(struct conn_debug_info_mt6985));

	if (level < 2)
		return;

	if (!vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6985) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6985(%x) ioremap fail\n",
	...
	/* C0 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
	...
	update_debug_write_info_mt6985_debug_gen(pdbg_level_2_info,
	...
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6985 + 0xAC4));

	/* C16 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"C16", 0x18050000 + 0xAC8,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6985 + 0xAC8));

	/* C17 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"C17", 0x18050000 + 0xACC,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt6985 + 0xACC));
...
void consys_print_bus_debug_dbg_level_1_mt6985_debug_gen(
		int level,
		struct conn_debug_info_mt6985 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
		...
		struct conn_debug_info_mt6985 *pdbg_level_2_info)
{
	...
	if (!vir_addr_0x1804c000_mt6985) {
		pr_notice("vir_addr_0x1804c000_mt6985(%x) ioremap fail\n",
				0x1804c000);
		return;
	}
	...
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"36", 0x1804c000 + 0xc,
		CONSYS_REG_READ(vir_addr_0x1804c000_mt6985 + 0xc));
	...
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"47", 0x1804c000 + 0x10,
		CONSYS_REG_READ(vir_addr_0x1804c000_mt6985 + 0x10));

	/* 48 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"48", 0x1804c000 + 0x4,
		CONSYS_REG_READ(vir_addr_0x1804c000_mt6985 + 0x4));
}

void consys_print_bus_slpprot_debug_dbg_level_2_mt6985_debug_gen(
		int level,
		struct conn_debug_info_mt6985 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
	...
	/* 4 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"4", 0x18001000 + CONSYS_DBG_GEN_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_CFG_ON_BASE +
			CONSYS_DBG_GEN_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_OFFSET_ADDR));

	/* 5 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"5", 0x18001000 + CONSYS_DBG_GEN_GALS_CONN2GPS_SLP_STATUS_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_CFG_ON_BASE +
			CONSYS_DBG_GEN_GALS_CONN2GPS_SLP_STATUS_OFFSET_ADDR));

	/* 6 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"6", 0x18001000 + CONSYS_DBG_GEN_GALS_GPS2CONN_SLP_STATUS_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_CFG_ON_BASE +
			CONSYS_DBG_GEN_GALS_GPS2CONN_SLP_STATUS_OFFSET_ADDR));

	/* 7 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"7", 0x1002C000 + CONSYS_DBG_GEN_SLEEP_PROT_EN_W1S_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6985 +
			CONSYS_DBG_GEN_SLEEP_PROT_EN_W1S_0_OFFSET_ADDR));

	/* 8 */
	update_debug_read_info_mt6985_debug_gen(pdbg_level_2_info,
		"8", 0x1002C000 + CONSYS_DBG_GEN_SLEEP_PROT_RDY_0_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_ifrbus_ao_reg_base_mt6985 +
